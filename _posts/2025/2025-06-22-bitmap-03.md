...
- [Bitmap(1) - Android Bitmap Config 및 기본 설정](https://goodmidnight.github.io/graphic/bitmap-01/)
- [Bitmap(2) - Android Bitmap 메모리 구조 및 관리 방식](https://goodmidnight.github.io/graphic/bitmap-02/)

`Android`의 `Matrix`에 대한 개념이 등장하기 때문에 해당 글을 참고하시면 좋습니다.

- [Matrix(1) - Android Matrix 구조 및 2D변환 적용 방식](https://goodmidnight.github.io/graphic/matrix-01/)
